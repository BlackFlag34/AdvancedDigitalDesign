...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ALU_0_Overflow [get_bd_pins ALU_0/Overflow] [get_bd_pins axi_regmap_0/REG4_IN]
  connect_bd_net -net ALU_0_R [get_bd_pins ALU_0/R] [get_bd_pins axi_regmap_0/REG0_IN]
  connect_bd_net -net ALU_0_Zero [get_bd_pins ALU_0/Zero] [get_bd_pins axi_regmap_0/REG5_IN]
